...
public class LinkedListIterator<T> implements Iterator<T> {
  ...
  /**
   * Create a new iterator for the linked list starting at a particular node of the list
   ...
   * @return true if the iterator has more elements because it has not yet reached the end of the list
   */
   ...
   * @throws NoSuchElementException if calling next after the iteration reached the end of the list
   */
  public T next() {
    if (hasNext()) {
